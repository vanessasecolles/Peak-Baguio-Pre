...
const LikedVsUnlikedReport = () => {
  ...
  return (
    <div id="report" className="p-6 bg-white shadow-lg rounded-lg mx-auto w-full sm:max-w-2xl">
      <h2 className="text-2xl font-bold mb-4 text-center">Liked vs. Unliked Itineraries Report</h2>
      <Chart
        chartType="PieChart"
        width="100%"
        height="400px"
